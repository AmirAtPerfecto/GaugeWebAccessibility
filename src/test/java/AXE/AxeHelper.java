...
public class AxeHelper {
  ...
  //  public static final String AXE_DEFAULT = "https://cdnjs.cloudflare.com/ajax/libs/axe-core/2.1.7/axe.min.js";
  public static final String AXE_DEFAULT = "https://cdnjs.cloudflare.com/ajax/libs/axe-core/2.3.1/axe.min.js";
  /**
  ...
  static {
    String axeres = System.getProperty("user.dir")+"/src/test/java/axe";// TBDConfigurationUtils.getBaseBundle().getPropertyValue("env.axeresources");


    highlightScript = loadResource( axeres + "/axeHighlighter.js");
    runAxeScript = loadResource(axeres + "/runAxe.js");
    startHighlighterScript = loadResource(axeres + "/startHighlighter.js");
  ...
  private static String loadResource(final String scriptName) {
    try {
      ...
      return new String ( Files.readAllBytes( Paths.get(scriptName)));
//      final InputStream highlighterSource = AxeHelper.class.getClassLoader().getResourceAsStream(scriptName);
//      return IOUtils.readFully(highlighterSource);
...
//      throw new PerfectoRuntimeException("Unable to load script: " + scriptName, e);
   ...
   *          The driver.
   */
  public AxeHelper(final WebDriver driver) {
    this((RemoteWebDriver) driver, AXE_DEFAULT);
  }
   ...
   */
  static class AxeHelperException extends CustomRuntimeException {
